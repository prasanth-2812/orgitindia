        ...
        <div className="bg-super-admin-surface-light dark:bg-super-admin-surface-dark rounded-xl shadow-soft border border-super-admin-border-light dark:border-super-admin-border-dark p-6">
          {activeTab === 'info' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Legal Entity Name</p>
              ...
              <div>
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Mobile</p>
                <p className="text-base text-gray-900 dark:text-white">{org.mobile || '-'}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">GST</p>
                <p className="text-base text-gray-900 dark:text-white">{org.gst || '-'}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">PAN</p>
                <p className="text-base text-gray-900 dark:text-white">{org.pan || '-'}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">CIN</p>
                <p className="text-base text-gray-900 dark:text-white">{org.cin || '-'}</p>
              </div>
              {org.address && (
                <div className="md:col-span-2">
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Address</p>
                  <p className="text-base text-gray-900 dark:text-white">{org.address}</p>
                </div>
              )}
            </div>
          )}
