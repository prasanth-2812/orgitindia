...
export const TaskGroupChatConversation: React.FC = () => {
  ...
  const conversationName = conversationData?.name || 'Task Group';
  const conversationPhoto = conversationData?.photoUrl || conversationData?.group_photo || '';
  const groupMembers = conversationData?.otherMembers || conversationData?.other_members || [];
      ...
      <header className="flex items-center justify-between px-4 py-3 bg-surface-light/95 dark:bg-background-dark/95 backdrop-blur-sm z-20 border-b border-gray-200 dark:border-gray-800 shadow-sm transition-colors duration-300">
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <div 
              className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 border border-gray-200 dark:border-gray-700 shadow-sm bg-primary/10 flex items-center justify-center"
